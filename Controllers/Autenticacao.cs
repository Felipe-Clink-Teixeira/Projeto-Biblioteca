    ...
    public class Autenticacao
    {
        ...
        public static bool verificaLoginSenha(string login, string senha, Controller controller)
        {
            using(BibliotecaContext bc = new BibliotecaContext())
            {
                ...
                senha = Ciptrografo.TextoCriptografado(senha);
        ...
        public static void verificaSeUsuarioAdminExiste(BibliotecaContext bc)
        {
            ...
            if(listaUsuarioEncontrado.Count() == 0)
            {
                ...
                Admin.Login = "admin";
                Admin.Senha = Ciptrografo.TextoCriptografado("123");
        ...
        public static void verificaseUsuarioEAdmin(Controller controller)
        {
            ...
            {
                controller.Request.HttpContext.Response.Redirect("/Usuario/administrador");
            }
        }
    }
}